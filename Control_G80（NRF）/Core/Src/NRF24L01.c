...
const uint8_t TX_ADDRESS[TX_ADR_WIDTH] = {0xA1, 0xA1, 0xA1, 0xA1, 0xA1}; //发送地址
const uint8_t RX_ADDRESS[RX_ADR_WIDTH] = {0xA1, 0xA1, 0xA1, 0xA1, 0xA1};
...
void NRF24L01_RX_Mode(void)
{
    ...
    NRF24L01_Write_Buf(NRF_WRITE_REG + TX_ADDR, (uint8_t *)RX_ADDRESS, TX_ADR_WIDTH);
